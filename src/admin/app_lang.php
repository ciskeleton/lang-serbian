...
$lang['admin_install_update_confirm'] = 'Da li ste sigurni da želite da ažurirate ovaj paket?';
$lang['admin_install_update_error'] = 'Ažuriranje paketa nije uspelo.';
$lang['admin_install_update_skip_confirm'] = 'Da li ste sigurni da želite da preskočite ovo ažuriranje?';
$lang['admin_install_update_skip_error'] = 'Preskakanje ovog ažuriranja nije uspelo.';
$lang['admin_install_update_skip_success'] = 'Ažuriranje je uspešno preskočeno.';
$lang['admin_install_update_success'] = 'Paket je uspešno ažuriran.';
...
$lang['admin_modules_delete_error_active'] = 'Aktivni moduli se ne mogu obrisati.';
...
$lang['admin_modules_global'] = 'Globalni modul (deljeno)';
$lang['admin_modules_install_confirm'] = 'Da li ste sigurni da želite da instalirate modul: <b>%s</b>?';
$lang['admin_modules_install_error'] = 'Instalacija modula nije uspela.';
$lang['admin_modules_install_success'] = 'Modul je uspešno instaliran.';
...
$lang['admin_modules_update_confirm'] = 'Da li ste sigurni da želite da ažurirate ovaj modul?';
$lang['admin_modules_update_error'] = 'Ažuriranje modula nije uspelo.';
$lang['admin_modules_update_success'] = 'Modul je uspešno ažuriran.';
...
$lang['admin_plugins_delete_error_active'] = 'Aktivni dodaci se ne mogu obrisati.';
...
$lang['admin_plugins_global'] = 'Globalni dodatak (deljeno)';
$lang['admin_plugins_install_confirm'] = 'Da li ste sigurni da želite da instalirate dodatak: <b>%s</b>?';
$lang['admin_plugins_install_error'] = 'Instalacija dodatka nije uspela.';
$lang['admin_plugins_install_success'] = 'Dodatak je uspešno instaliran.';
...
$lang['admin_plugins_update_confirm'] = 'Da li ste sigurni da želite da ažurirate ovaj dodatak?';
$lang['admin_plugins_update_error'] = 'Ažuriranje dodatka nije uspelo.';
$lang['admin_plugins_update_success'] = 'Dodatak je uspešno ažuriran.';
...
$lang['admin_themes_install_confirm'] = 'Da li ste sigurni da želite da instalirate temu: <b>%s</b>?';
$lang['admin_themes_install_error'] = 'Instalacija teme nije uspela.';
$lang['admin_themes_install_success'] = 'Tema je uspešno instalirana.';
...
$lang['admin_themes_update_confirm'] = 'Da li ste sigurni da želite da ažurirate ovu temu?';
$lang['admin_themes_update_error'] = 'Ažuriranje teme nije uspelo.';
$lang['admin_themes_update_success'] = 'Tema je uspešno ažurirana.';
...
$lang['admin_languages_delete_confirm'] = 'Da li ste sigurni da želite da obrišete jezik: <b>%s</b>?';
$lang['admin_languages_delete_error'] = 'Brisanje jezika nije uspelo.';
$lang['admin_languages_delete_error_active'] = 'Aktivni jezici se ne mogu obrisati.';
$lang['admin_languages_delete_error_default'] = 'Podrazumevani jezik se ne može obrisati.';
$lang['admin_languages_delete_success'] = 'Jezik je uspešno obrisan.';
...
$lang['admin_languages_install_confirm'] = 'Da li ste sigurni da želite da instalirate jezik: <b>%s</b>?';
$lang['admin_languages_install_error'] = 'Instalacija jezika nije uspela.';
$lang['admin_languages_install_success'] = 'Jezik je uspešno instaliran.';
...
$lang['admin_languages_update_confirm'] = 'Da li ste sigurni da želite da ažurirate ovaj jezik?';
$lang['admin_languages_update_error'] = 'Ažuriranje jezika nije uspelo.';
$lang['admin_languages_update_success'] = 'Jezik je uspešno ažuriran.';
...
$lang['package_archive_download_failed'] = 'Preuzimanje arhive paketa nije uspelo.';
$lang['package_backup_create_error'] = 'Neuspelo kreiranje rezervne kopije paketa.';
$lang['package_backup_dir_failed'] = 'Kreiranje rezervne fascikle %s nije uspelo';
$lang['package_backup_missing'] = 'Datoteka rezervne kopije ne postoji.';
$lang['package_backup_path_error'] = 'Nije moguće razrešiti putanju datoteke rezervne kopije.';
$lang['package_backup_request_invalid'] = 'Nevažeći zahtev za rezervnu kopiju.';
$lang['package_backup_restore_error'] = 'Neuspelo vraćanje rezervne kopije paketa.';
$lang['package_catalog_type_unknown'] = 'Nepoznata vrsta kataloga.';
$lang['package_checksum_error'] = 'Provera kontrolnog zbira (checksum) paketa nije uspela.';
$lang['package_copy_files_error'] = 'Neuspelo kopiranje datoteka paketa na odredište.';
$lang['package_copy_updates_error'] = 'Neuspelo kopiranje datoteka ažuriranja na odredište.';
$lang['package_dest_dir_failed'] = 'Kreiranje odredišne fascikle %s nije uspelo';
$lang['package_destination_error'] = 'Nije moguće odrediti odredište paketa.';
$lang['package_download_dir_failed'] = 'Kreiranje fascikle za preuzimanje %s nije uspelo';
$lang['package_download_empty'] = 'Preuzimanje paketa vratilo je prazan odgovor.';
$lang['package_download_request_invalid'] = 'Nevažeći zahtev za preuzimanje paketa.';
$lang['package_extract_failed'] = 'Raspakivanje ZIP-a %s nije uspelo';
$lang['package_invalid_lang_files'] = 'Nevažeći jezik — nedostaju obavezne jezičke datoteke aplikacije.';
$lang['package_invalid_lang_structure'] = 'Nevažeći jezik — nedostaju admin i/ili ci3 direktorijumi.';
$lang['package_invalid_missing_info'] = 'Nevažeći %s: nedostaje „info.php“.';
$lang['package_invalid_module_structure'] = 'Nevažeći modul — nedostaju obavezni config i/ili controllers direktorijumi.';
$lang['package_invalid_plugin_boot'] = 'Nevažeći dodatak (plugin) — nedostaje "boot.php".';
$lang['package_invalid_plugin_contents'] = 'Nevažeći dodatak (plugin) — dodaci ne mogu sadržati kontrolere ili prikaze (views).';
$lang['package_invalid_theme_boot'] = 'Nevažeća tema — nedostaje "boot.php".';
$lang['package_invalid_theme_views'] = 'Nevažeća tema — nedostaje views direktorijum.';
$lang['package_no_root_dir'] = 'Paket ne sadrži korijenski direktorijum.';
...
$lang['package_request_invalid'] = 'Nevažeći zahtev za paket.';
$lang['package_rollback_request_invalid'] = 'Nevažeći zahtev za vraćanje na prethodnu verziju (rollback).';
$lang['package_root_mismatch'] = 'Koreni direktorijum arhive paketa se ne podudara sa %s';
$lang['package_single_root_required'] = 'Paket mora sadržati tačno jedan korijenski direktorijum.';
...
$lang['package_temp_dir_failed'] = 'Kreiranje privremene fascikle %s nije uspelo';
$lang['package_type_unknown'] = 'Nepoznata vrsta paketa.';
$lang['package_update_request_invalid'] = 'Nevažeći zahtev za ažuriranje paketa.';
$lang['package_update_root_mismatch'] = 'Koreni direktorijum arhive ažuriranja se ne podudara sa %s.';
$lang['package_upload_dir_failed'] = 'Kreiranje fascikle za otpremanje %s nije uspelo';
$lang['package_url_invalid'] = 'Nevažeći URL za distribuciju paketa.';
$lang['package_write_failed'] = 'Upisivanje paketa u %s nije uspelo';
...
$lang['update_rollback_confirm'] = 'Da li ste sigurni da želite da vratite prethodnu verziju?';
